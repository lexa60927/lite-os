...
export class ChunkView {
  ...
  /** Есть ли у чанка меш. Нужно прицелу: рамку выделения показывать только там,
   * где блок действительно нарисован, иначе она висит в небе над неотрисованным
   * чанком (край дистанции прокрутки) — «призрак-блок». */
  hasMesh(cx, cz) { return this.objects.has(ChunkView.key(cx, cz)); }
